...
Evidence base: 16 prototype-walkthrough interviews conducted on 2026-04-28
(Adiena 1–4, Alex 1–5, Catherine 2–4 [4 participants across those files],
Marcus 1–3 [5 participants across those files]).
...
- Marcus 1, P1 & P2: both named indoor as the priority feature — "After
  first year, you usually know where most buildings are, but you do not
  always know where the classrooms are inside"
- Marcus 1, P1: gave a specific recalled near-miss — "There was one time
...
- Marcus 1, P2: identified an entrance-level routing problem — "if my
...
- Adiena 1, P1; Adiena 2, P2; Adiena 4, P4; Marcus 1, P2; Marcus 2, P3;
...
*Counter-evidence:*
- Marcus 2, P3 & P4: said Google Maps was usually pretty accurate for
...
- Catherine 4, P5: "the design is quite clear... colors are also not
  too much"
- Marcus 1, P1 & P2: positive reaction to the timetable — "That is
...
- Marcus 2, P3: "I would definitely use the notification"
...
- Marcus 2, P3 & P4: "Probably more details. Just tell me how late
